...
A barbearia oferece os seguintes planos:
- Plano Cabelo - R$ 74,90
- Plano Barba - R$ 74,90
- Plano Cabelo e Barba - R$ 154,90
- Ambiente: Cadeiras de couro, cerveja gelada, sinuca e música boa.
Localização: R. Caiena, Qd 16 Lt 29 Sala D - Novo Horizonte, Parauapebas - PA.
Horário: Seg-Sáb, 09h às 20h.

Sempre seja cordial, use um tom masculino e profissional. 
Se o usuário quiser agendar, forneça este link com mensagem pronta: https://wa.me/5594992496583?text=Ola%21%20Vim%20pelo%20site%20da%20Fonseca%20Barber%20Club%20e%20quero%20agendar%20meu%20horario.%20Pode%20me%20mostrar%20os%20horarios%20disponiveis%3F`;
          ...
          >
            ...
            <div className="bg-zinc-800 p-4 border-b border-gold/20 flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gold">Fonseca Barber Club</h3>
